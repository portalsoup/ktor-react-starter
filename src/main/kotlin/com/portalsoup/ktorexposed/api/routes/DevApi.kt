...
import com.portalsoup.ktorexposed.service.BlogPostService
    ...
    post("load-data") {
        ...
        BlogPostService.create(listOf(
            BlogPostResource(
                ...
                transaction { com.portalsoup.ktorexposed.entity.Route.findById(importedRoute.id ?: 1) },
